...
@testset "function nodePopReport" begin
    ...
    @test all( report[ :active ] .== vcat( 30, 60, 84, 108, 124, 140, 156, 172,
        188, 204, 196, fill( 188, 15 ) ) )
    @test all( report[ Symbol( "A junior" ) ] .== vcat( 10, fill( 20, 25 ) ) )
    @test all( report[ :Career ] .== vcat( 0, 0, 24, 48, 64, 80, 96, 112, 128, 144, 136, fill( 128, 15 ) ) )
